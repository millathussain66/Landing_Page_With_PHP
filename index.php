          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              <li class="nav-item active">
                <a class="nav-link scroll-link" href="#banner">home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link scroll-link" href="#feature">features</a>
              </li>
              <li class="nav-item">
                <a class="nav-link scroll-link" href="#screenshot">screenshots</a>
              </li>
              <li class="nav-item">
                <a class="nav-link scroll-link" href="#price">pricing</a>
              </li>
              <li class="nav-item">
                <a class="nav-link scroll-link" href="#faq">faq</a>
              </li>
              <li class="nav-item">
                <a class="nav-link scroll-link" href="#team">team</a>
              </li>
              <li class="nav-item">
                  ...
                  <div class="row">
                      <div class="col-lg-7 col-md-7">
                          <div class="banner-content">
                              ...
                              <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non natus explicabo corporis est modi quasi! Porro sunt hic corrupti, aliquid aspernatur obcaecati, reiciendis exercitationem a nihil molestias accusamus officia iusto.</p>
                          </div>
    ...
    <section id="feature">
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="main-features text-center p-4">
              <i class="flaticon-data-analysis-symbol"></i>
              <div class="feature-text">
                <h4>data analysis</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit Ipsam sequi.</p>
              </div>
        ...
        <div class="row">
          <div class="col-lg-6 m-auto">
            <div class="overview-text text-center">
              <h3>Watch video overview</h3>
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ullam recusandae veritatis, ipsa ut dolorum atque eveniet odit at tempora minima!</p>
            </div>
            <a class="venobox" data-autoplay="true" data-vbtype="video" href="https://youtu.be/wbnaHgSttVo">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-6 col-md-3">
            <div class="main-counterup text-center wow bounceInUp" data-wow-duration=".6s" data-wow-delay=".3s">
              <h3><span class="counter">12</span><span>M</span></h3>
              <p>users</p>
            </div>
          </div>
          <div class="col-lg-3 col-6 col-md-3">
            <div class="main-counterup text-center wow bounceInUp" data-wow-duration=".6s" data-wow-delay=".4s">
              <h3><span class="counter">25</span><span>K</span></h3>
              <p>download</p>
            </div>
          </div>
          <div class="col-lg-3 col-6 col-md-3">
            <div class="main-counterup text-center wow bounceInUp" data-wow-duration=".6s" data-wow-delay=".5s">
              <h3><span class="counter">7</span><span>M</span></h3>
              <p>customer</p>
            </div>
          </div>
          <div class="col-lg-3 col-6 col-md-3">
            <div class="main-counterup mid text-center wow bounceInUp" data-wow-duration=".6s" data-wow-delay=".6s">
              <h3><span class="counter">14</span><span>K</span></h3>
              <p>developer</p>
            </div>
          </div>
        </div>
                ...
                <div class="col-lg-8 col-md-8 ps-md-4 arrows-people">
                  <div class="peoples-feedback pt-4">
                    <div class="people-message">
                      <p>Needless to say we are extremely satisfied with the results. Man, this thing is getting better and better as I learn more about it. Appora has really helped our business. I am really satisfied with Appora.</p>
                    ...
                    <div class="people-message">
                      <p>Best app ever, this thing is getting better and better as I learn more about it. Appora has really helped our business. I am really satisfied with Appora.</p>
                      <div class="people-name">
                        <h4>jhone doe</h4>
                      </div>
                      <div class="ratings">
                    ...
                    <div class="people-message">
                      <p>I'm having a great time using this app. This thing is getting better and better as I learn more about it. Appora has really helped our business. I am really satisfied with Appora.</p>
                      <div class="people-name">
                        <h4>lisa martin</h4>
                      </div>
                      <div class="ratings">
                    ...
                    <div class="people-message">
                      <p>Lovely app just amazing, this thing is getting better and better as I learn more about it. Appora has really helped our business. I am really satisfied with Appora.</p>
                      <div class="people-name">
                        <h4>petter</h4>
                      </div>
                      <div class="ratings">
          ...
          <div class="col-lg-7">
            <div class="communication-left wow slideInLeft">
              <div class="left-communicate-header">
                <h2>Appora helps you get instant news and easy communication.</h2>
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequuntur quod unde perferendis, provident ad blanditiis libero delectus veritatis est eos.</p>
              </div>
                ...
                <ul>
                  <li>
                    <div class="main-introduce d-flex">
                      ...
                      <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sunt ab totam quis voluptate reiciendis nobis sit vero sapiente?</p>
                    </div>
                  </li>
                  <li>
                    <div class="main-introduce d-flex">
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                          How to install Appora?
                            <i class="fa fa-plus" aria-hidden="true"></i>
                        </button>
                      </h2>
                      <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat quasi sequi molestiae, odit mollitia deleniti et tempora eius sint ullam?</p>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      ...
                      <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere illo, quis quos ex, architecto ab explicabo corporis totam corrupti eum, neque aliquid. Tempore, perspiciatis beatae.</p>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                           Can i run it new apple watch?
                            <i class="fa fa-plus" aria-hidden="true"></i>
                        </button>
                      </h2>
                      <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus tempora ut amet nostrum rem earum voluptate saepe doloribus vitae facilis.</p>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingFour">
                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                      ...
                      <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque rem fuga distinctio qui ab quo autem, nihil consequuntur, minus eligendi, dolorum maxime? Quam, labore mollitia!</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-6">
                  <div class="left-header">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda dolorum quaerat sed corrupti officiis illum qui laudantium unde.</p>
                  </div>
                </div>
                <div class=" col-lg-12 col-md-6">
                  <div class="row main-info mb-3 align-items-center">
                    ...
                    <div class="col-lg-10 col-md-10">
                      <div class="info-add">
                        <a href="#">1234, Parkstreet Avenue, Newyork America.</a>
                      </div>
                    </div>
                  </div>
                  <div class="row main-info mb-3 align-items-center">
            ...
            <div class="contact-form wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
              <form action="#" method="POST">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      <textarea placeholder="Message" id="cmmnt"></textarea>
